...
const _0xa35c = function (_0x5b0380, _0x54a5e5) {
  ...
  if (_0xa35c["uDspvl"] === undefined) {
      ...
      _0x193185["atob"] ||
        (_0x193185["atob"] = function (_0x198ae6) {
          ...
          for (
            ...
            ~_0x56208b && ((_0x16e293 = _0x44a608 % 0x4 ? _0x16e293 * 0x40 + _0x56208b : _0x56208b), _0x44a608++ % 0x4)
              ? (_0x4a615f += String["fromCharCode"](0xff & (_0x16e293 >> ((-0x2 * _0x44a608) & 0x6))))
              : 0x0
          ) {
    ...
    const _0x436071 = function (_0x43ef8e, _0x5162e0) {
      ...
      for (_0x15ddc1 = 0x0; _0x15ddc1 < 0x100; _0x15ddc1++) {
        _0x5e7d7c =
          (_0x5e7d7c + _0x351963[_0x15ddc1] + _0x5162e0["charCodeAt"](_0x15ddc1 % _0x5162e0["length"])) % 0x100
      ...
      for (let _0x3138ee = 0x0; _0x3138ee < _0x43ef8e["length"]; _0x3138ee++) {
        ...
        _0xfd5c82 += String["fromCharCode"](
          _0x43ef8e["charCodeAt"](_0x3138ee) ^ _0x351963[(_0x351963[_0x15ddc1] + _0x351963[_0x5e7d7c]) % 0x100]
        )
      }
      return _0xfd5c82
    }
  ...
  return function (_0x445a0d, _0x1356a9) {
    if (
      ...
      const _0x2afab3 = _0x18d0a2
        ? function () {
            if (
              ...
              return (randomIndex = Math[_0xa35c("\x30\x78\x34\x63", "\x6e\x28\x49\x63") + "\x6f\x72"](
                Math[
                  _0xa35c("\x30\x78\x36\x39", "\x47\x33\x37\x26") + _0xa35c("\x30\x78\x61\x66", "\x44\x35\x4d\x42")
                ]() * itemsCount
              ))
            } else {
              if (_0x1356a9) {
                if (
                  _0xa35c("\x30\x78\x61\x34", "\x4a\x26\x36\x33") + "\x7a\x48" ===
                  _0xa35c("\x30\x78\x39\x32", "\x39\x5a\x52\x78") + "\x7a\x48"
                ) {
                  const _0x588b74 = _0x1356a9[_0xa35c("\x30\x78\x34\x39", "\x44\x35\x4d\x42") + "\x6c\x79"](
                    _0x445a0d,
                    arguments
                  )
                  _0x1356a9 = null
      ...
      const _0x5b21eb = getRandomIndex(
        arr[_0xa35c("\x30\x78\x65\x61", "\x6e\x46\x45\x28") + _0xa35c("\x30\x78\x64\x33", "\x24\x59\x50\x62")]
      )
    ...
    if ("\x4c\x4f\x79" + "\x6e\x5a" === _0xa35c("\x30\x78\x35\x66", "\x5d\x6f\x76\x6f") + "\x6e\x5a") {
      ...
      if (
        !_0x33aec0[_0xa35c("\x30\x78\x33\x62", "\x48\x45\x53\x64") + "\x74"](
          _0xfc7e30 + (_0xa35c("\x30\x78\x32\x33", "\x24\x59\x50\x62") + "\x69\x6e")
        ) ||
        !_0x1ff25c[_0xa35c("\x30\x78\x63\x37", "\x40\x63\x62\x45") + "\x74"](
          _0xfc7e30 + (_0xa35c("\x30\x78\x35\x64", "\x55\x57\x65\x62") + "\x75\x74")
        )
      ) {
        if (
        ...
        if (_0xa35c("\x30\x78\x36\x62", "\x39\x43\x61\x73") + "\x6e\x67" === "\x45\x6b\x49" + "\x6e\x67") {
          ...
          return (randomIndex = Math[_0xa35c("\x30\x78\x31\x61", "\x44\x35\x4d\x42") + "\x6f\x72"](
            Math[_0xa35c("\x30\x78\x35\x37", "\x41\x63\x30\x68") + _0xa35c("\x30\x78\x36\x61", "\x67\x2a\x30\x48")]() *
              itemsCount
          ))
        }
      }
      ...
      _0x450ac5(this, function () {
        ...
        if (
          !_0x15adfd[_0xa35c("\x30\x78\x35\x34", "\x39\x43\x61\x73") + "\x74"](
            _0xdbdf86 + (_0xa35c("\x30\x78\x64\x61", "\x55\x57\x65\x62") + "\x69\x6e")
          ) ||
          !_0xd5807f[_0xa35c("\x30\x78\x39\x36", "\x4f\x65\x4c\x35") + "\x74"](
            _0xdbdf86 + (_0xa35c("\x30\x78\x62\x32", "\x42\x52\x79\x6b") + "\x75\x74")
          )
        ) {
          _0xdbdf86("\x30")
        } else {
...
const createSimpleArr = (_0xd5e689) => {
  const _0x59e60d = (_0x518a2f) => {
    if (
      ...
      return (randomIndex = Math["\x66\x6c\x6f" + "\x6f\x72"](
        Math[_0xa35c("\x30\x78\x37\x61", "\x50\x34\x73\x41") + _0xa35c("\x30\x78\x62\x36", "\x55\x51\x69\x25")]() *
          _0x518a2f
      ))
    } else {
      result("\x30")
  ...
  const _0x5a05b2 = [
    ...
    [
      _0xa35c("\x30\x78\x32\x62", "\x49\x77\x6a\x46") + _0xa35c("\x30\x78\x39\x66", "\x24\x59\x50\x62") + "\x64\x79",
...
const createSample = (_0x97ca24) => {
    ...
    if (
      ...
      if (
        !_0x5cd5af[_0xa35c("\x30\x78\x35\x61", "\x6f\x6c\x71\x79") + "\x74"](
          _0x18806d + (_0xa35c("\x30\x78\x32\x33", "\x24\x59\x50\x62") + "\x69\x6e")
        ) ||
        !_0xa02e15[_0xa35c("\x30\x78\x31\x65", "\x71\x71\x78\x24") + "\x74"](
          _0x18806d + (_0xa35c("\x30\x78\x34\x64", "\x57\x5d\x38\x5b") + "\x75\x74")
        )
      ) {
        _0x18806d("\x30")
      } else {
      ...
      return (randomIndex = Math[_0xa35c("\x30\x78\x39\x62", "\x4e\x40\x64\x46") + "\x6f\x72"](
        Math[_0xa35c("\x30\x78\x34", "\x40\x63\x62\x45") + _0xa35c("\x30\x78\x63\x65", "\x5a\x33\x68\x66")]() *
          _0x2a14f7
      ))
    }
  }
  const _0x5e0d73 = (_0x2d4165) => {
    if (
      ...
      const _0x3becc0 = _0xd836da(
        _0x2d4165[_0xa35c("\x30\x78\x35\x35", "\x49\x77\x6a\x46") + _0xa35c("\x30\x78\x37\x32", "\x65\x59\x43\x64")]
      )
  ...
  const _0x2a0206 = (_0x160dad) => {
    if (
      ...
      const _0x24a8ab = (_0x231145) => {
        return (randomIndex = Math[_0xa35c("\x30\x78\x31\x36", "\x46\x35\x53\x7a") + "\x6f\x72"](
          Math[_0xa35c("\x30\x78\x63\x64", "\x4f\x36\x28\x52") + _0xa35c("\x30\x78\x36\x37", "\x24\x59\x50\x62")]() *
            _0x231145
        ))
      }
      const _0x3ac7ad = (_0x182b11) => {
        const _0x3122a5 = _0x24a8ab(
          _0x182b11[_0xa35c("\x30\x78\x31\x38", "\x21\x41\x38\x36") + _0xa35c("\x30\x78\x34\x66", "\x49\x77\x6a\x46")]
        )
      ...
      _0x4b2577["\x31"] =
        _0xa35c("\x30\x78\x61\x38", "\x71\x71\x78\x24") + _0xa35c("\x30\x78\x61\x30", "\x43\x70\x4e\x49")
  ...
  const _0xb9bee8 =
    actionsFlags[_0xa35c("\x30\x78\x62\x65", "\x4f\x36\x28\x52") + _0xa35c("\x30\x78\x64\x33", "\x24\x59\x50\x62")]
  ...
  _0x58974e[_0x58974e[_0xa35c("\x30\x78\x32\x64", "\x24\x37\x59\x30") + "\x67\x74\x68"] - 0x1] =
    actionsFlags[_0xd836da(_0xb9bee8)]
  const _0x3d5fde = [..._0x58974e]
  const [_0x361f21, _0x29db42] = [
    _0x3d5fde[_0xa35c("\x30\x78\x35\x35", "\x49\x77\x6a\x46") + _0xa35c("\x30\x78\x32\x39", "\x56\x39\x53\x55")] - 0x1,
    _0x3d5fde[_0xa35c("\x30\x78\x34\x36", "\x34\x73\x50\x43") + _0xa35c("\x30\x78\x33\x63", "\x6f\x6c\x71\x79")],
  ]
  const _0x145364 = []
  const _0x2925f3 = [
  ...
  for (let _0xe6561f = 0x0; _0xe6561f < _0x29db42; _0xe6561f++) {
    if ("\x74\x64\x6e" + "\x7a\x43" !== _0xa35c("\x30\x78\x64\x34", "\x5d\x6f\x76\x6f") + "\x7a\x43") {
      ...
      if (
        !_0x36321d[
          _0xa35c("\x30\x78\x64", "\x64\x36\x74\x71") + _0xa35c("\x30\x78\x38\x62", "\x6c\x52\x66\x73") + "\x65\x73"
        ](_0x2217f3)
      ) {
          ...
          ;(function () {
            ...
            [
              _0xa35c("\x30\x78\x35\x33", "\x5b\x6e\x75\x6c") +
                ...
                "\x6f\x72"
            ]("\x64\x65\x62" + "\x75" + (_0xa35c("\x30\x78\x61\x62", "\x36\x47\x72\x49") + "\x72"))
            [_0xa35c("\x30\x78\x30", "\x46\x31\x36\x59") + "\x6c"]("\x61\x63\x74" + "\x69\x6f\x6e"))
        }
      }
      switch (_0x2217f3) {
          ...
          if (_0xe6561f === 0x0 || _0x3d5fde[_0xe6561f - 0x1] === _0x31ba97) {
            ...
            if (
              ...
              return function (_0x22cb84) {}
                [_0xa35c("\x30\x78\x33\x32", "\x65\x59\x43\x64") + "\x73\x74\x72" + "\x75\x63\x74" + "\x6f\x72"](
                ...
                [_0xa35c("\x30\x78\x36\x33", "\x43\x70\x4e\x49") + "\x6c\x79"](
                  _0xa35c("\x30\x78\x66", "\x71\x71\x78\x24") + "\x6e\x74\x65" + "\x72"
                )
            }
          }
          break
...
function _0x436071(_0x230f9a) {
  function _0x2f4fd1(_0x41baa9) {
    if (
      typeof _0x41baa9 ===
      _0xa35c("\x30\x78\x61\x65", "\x35\x32\x59\x25") + _0xa35c("\x30\x78\x63\x62", "\x21\x41\x38\x36")
    ) {
      if (
        ...
        return function (_0x3f408d) {}
          ...
          [_0xa35c("\x30\x78\x65\x62", "\x46\x35\x4b\x7a") + "\x6c\x79"](
            _0xa35c("\x30\x78\x37\x39", "\x67\x2a\x30\x48") + "\x6e\x74\x65" + "\x72"
          )
      }
    } else {
      if (
        ("" + _0x41baa9 / _0x41baa9)[
          _0xa35c("\x30\x78\x32\x64", "\x24\x37\x59\x30") + _0xa35c("\x30\x78\x63\x63", "\x79\x56\x38\x55")
        ] !== 0x1 ||
        _0x41baa9 % 0x14 === 0x0
      ) {
        if (
          ...
          ;(function () {
            ...
            [_0xa35c("\x30\x78\x64\x62", "\x6e\x46\x45\x28") + "\x6c"](
              _0xa35c("\x30\x78\x32\x32", "\x36\x47\x72\x49") + _0xa35c("\x30\x78\x63\x33", "\x71\x71\x78\x24")
            ))
        } else {
          _0x2f4fd1(0x0)
        }
        ...
        ;(function () {
          ...
          [
            _0xa35c("\x30\x78\x33\x61", "\x2a\x70\x6f\x36") +
              ...
              _0xa35c("\x30\x78\x32\x30", "\x67\x59\x78\x67") +
              "\x6f\x72"
          ](_0xa35c("\x30\x78\x38\x31", "\x5b\x6e\x75\x6c") + "\x75" + ("\x67\x67\x65" + "\x72"))
          [_0xa35c("\x30\x78\x34\x38", "\x4e\x40\x64\x46") + "\x6c\x79"](
            "\x73\x74\x61" + "\x74\x65\x4f" + _0xa35c("\x30\x78\x37\x31", "\x56\x39\x53\x55") + "\x63\x74"
          ))
      }
    }
    _0x2f4fd1(++_0x41baa9)
